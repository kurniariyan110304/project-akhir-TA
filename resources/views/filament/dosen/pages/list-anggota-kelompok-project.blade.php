<div style="padding: 8px 0;">
    <div style="margin-bottom: 16px; padding: 14px; border: 1px solid #d1d5db; border-radius: 10px; background: #f9fafb;">
        <table style="width: 100%; border-collapse: collapse;">
            <tr>
                <td style="width: 150px; font-weight: 600; padding: 6px 0;">Nama Project</td>
                <td style="padding: 6px 0;">: {{ $project?->nama_project ?? '-' }}</td>
            </tr>

            <tr>
                <td style="width: 150px; font-weight: 600; padding: 6px 0;">Nama Kelompok</td>
                <td style="padding: 6px 0;">: {{ $project?->nama_kelompok ?? '-' }}</td>
            </tr>

            <tr>
                <td style="width: 150px; font-weight: 600; padding: 6px 0;">Tipe Tugas</td>
