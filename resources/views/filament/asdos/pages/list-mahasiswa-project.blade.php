            ...
            <table style="width: 100%; border-collapse: collapse; border: 1px solid #9ca3af; font-size: 14px;">
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="border: 1px solid #9ca3af; padding: 10px;">{{ $project?->mahasiswa?->nim ?? '-' }}</td>
                        <td style="border: 1px solid #9ca3af; padding: 10px;">{{ $project?->mahasiswa?->nama ?? '-' }}</td>
                        <td style="border: 1px solid #9ca3af; padding: 10px;">{{ $project?->mahasiswa?->email ?? '-' }}</td>
                        <td style="border: 1px solid #9ca3af; padding: 10px;">{{ $project?->nilai_akhir ?? 0 }}</td>
                    </tr>
                </tbody>
            </table>
        </div>
